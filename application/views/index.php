...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="/themes/farmie/img/core-img/favicon.ico">
  <!-- Core Stylesheet -->
  <link rel="stylesheet" href="/themes/farmie/style.css">
</head>
...
<body>
          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta text-right">
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="vibaoquoc@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> <span>Email: vibaoquoc@gmail.com</span></a>
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="+84 906099321"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: +84 906099321</span></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="classy-nav-container breakpoint-off">
        <div class="container">
          ...
          <nav class="classy-navbar justify-content-between" id="famieNav">
            <!-- Nav Brand -->
            <a href="index.html" class="nav-brand"><img src="/themes/farmie/img/core-img/logo.png" alt=""></a>
            <!-- Navbar Toggler -->
  ...
  <div class="hero-area">
    <div class="welcome-slides owl-carousel">
      ...
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(/themes/farmie/img/bg-img/1.jpg);">
      ...
      <!-- Single Welcome Slides -->
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(/themes/farmie/img/bg-img/7.jpg);">
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12 col-lg-10">
              <div class="welcome-content">
      ...
      <div class="row">
        <div class="col-12">
          <div class="benefits-thumbnail mb-50">
            <img src="/themes/farmie/img/bg-img/2.jpg" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="100ms">
            <img src="/themes/farmie/img/core-img/digger.png" alt="">
            <h5>Best Services</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="300ms">
            <img src="/themes/farmie/img/core-img/windmill.png" alt="">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms">
            <img src="/themes/farmie/img/core-img/cereals.png" alt="">
            <h5>100% Natural</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="700ms">
            <img src="/themes/farmie/img/core-img/tractor.png" alt="">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="900ms">
            <img src="/themes/farmie/img/core-img/sunrise.png" alt="">
            <h5>Organic food</h5>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-8">
          <div class="about-us-content mb-100">
            ...
            <div class="section-heading">
              ...
              <img src="/themes/farmie/img/core-img/decor.png" alt="">
            </div>
        ...
        <div class="col-12 col-md-4">
          <div class="famie-video-play mb-100">
            <img src="/themes/farmie/img/bg-img/6.jpg" alt="">
            <!-- Play Icon -->
  ...
  <section class="services-area d-flex flex-wrap">
    <!-- Service Thumbnail -->
    <div class="services-thumbnail bg-img jarallax" style="background-image: url('/themes/farmie/img/bg-img/7.jpg');"></div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="100ms">
              ...
              <div class="service-title mb-3 d-flex align-items-center">
                <img src="/themes/farmie/img/core-img/s1.png" alt="">
          ...
          <div class="col-12 col-lg-6">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="300ms">
              <!-- Service Title -->
              <div class="service-title mb-3 d-flex align-items-center">
                <img src="/themes/farmie/img/core-img/s2.png" alt="">
                <h5>Meat &amp; Eggs</h5>
              </div>
              <p>Intiam eu sagittis est, aster cosmo lacini libero. Praesent dignissim sed odio velo aliquam manta legolas. </p>
            </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="500ms">
              <!-- Service Title -->
              <div class="service-title mb-3 d-flex align-items-center">
                <img src="/themes/farmie/img/core-img/s3.png" alt="">
                <h5>Milk &amp; Cheese</h5>
              </div>
              <p>Intiam eu sagittis est, aster cosmo lacini libero. Praesent dignissim sed odio velo aliquam manta legolas. </p>
            </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="700ms">
              <!-- Service Title -->
              <div class="service-title mb-3 d-flex align-items-center">
                <img src="/themes/farmie/img/core-img/s4.png" alt="">
                <h5>Rice &amp; Corn</h5>
              </div>
              <p>Intiam eu sagittis est, aster cosmo lacini libero. Praesent dignissim sed odio velo aliquam manta legolas. </p>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-heading text-center">
            ...
            <img src="/themes/farmie/img/core-img/decor2.png" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
            ...
            <div class="product-thumbnail">
              <img src="/themes/farmie/img/bg-img/p1.jpg" alt="">
              <!-- Product Tags -->
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="300ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="/themes/farmie/img/bg-img/p2.jpg" alt="">
              <!-- Product Meta Data -->
              <div class="product-meta-data">
                <a href="#" data-toggle="tooltip" data-placement="top" title="Favourite"><i class="icon_heart_alt"></i></a>
                <a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon_cart_alt"></i></a>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="500ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="/themes/farmie/img/bg-img/p3.jpg" alt="">
              <!-- Product Meta Data -->
              <div class="product-meta-data">
                <a href="#" data-toggle="tooltip" data-placement="top" title="Favourite"><i class="icon_heart_alt"></i></a>
                <a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon_cart_alt"></i></a>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="700ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="/themes/farmie/img/bg-img/p4.jpg" alt="">
              <!-- Product Tags -->
  ...
  <section class="newsletter-area section-padding-100 bg-img bg-overlay jarallax" style="background-image: url('/themes/farmie/img/bg-img/8.jpg');">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="100ms">
            ...
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/9.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/chicken.png" alt="">
              </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="200ms">
            <!-- Thumbnail -->
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/10.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/pig.png" alt="">
              </div>
              <span>Farming practice for</span>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="300ms">
            <!-- Thumbnail -->
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/11.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/cow.png" alt="">
              </div>
              <span>Farming practice for</span>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="400ms">
            <!-- Thumbnail -->
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/12.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/cereal.png" alt="">
              </div>
              <span>Farming practice for</span>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="500ms">
            <!-- Thumbnail -->
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/13.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/sprout.png" alt="">
              </div>
              <span>Farming practice for</span>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-farming-practice-area mb-50 wow fadeInUp" data-wow-delay="600ms">
            <!-- Thumbnail -->
            <div class="farming-practice-thumbnail">
              <img src="/themes/farmie/img/bg-img/14.jpg" alt="">
            </div>
            <!-- Content -->
            <div class="farming-practice-content text-center">
              <!-- Icon -->
              <div class="farming-icon">
                <img src="/themes/farmie/img/core-img/vegetable.png" alt="">
              </div>
              <span>Farming practice for</span>
  ...
  <section class="testimonial-area bg-img bg-overlay section-padding-100 jarallax" style="background-image: url('/themes/farmie/img/bg-img/15.jpg');">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Testimonial Slides -->
            ...
            <div class="single-slide">
              ...
              <div class="testi-text d-flex">
                <div class="quote-icon">
                  <img src="/themes/farmie/img/core-img/quote.png" alt="">
                </div>
              ...
              <div class="testimonial-thumbnail-name d-flex align-items-center">
                <div class="testimonial-thumbnail">
                  <img src="/themes/farmie/img/bg-img/16.jpg" alt="">
                </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-6">
          <div class="featured-post-area mb-100 wow fadeInUp" data-wow-delay="100ms">
            <img src="/themes/farmie/img/bg-img/17.jpg" alt="">
            <!-- Post Content -->
  ...
  <footer class="footer-area">
    <!-- Main Footer Area -->
    <div class="main-footer bg-img bg-overlay section-padding-80-0" style="background-image: url(/themes/farmie/img/bg-img/3.jpg);">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="footer-widget mb-80">
              <a href="#" class="foo-logo d-block mb-30"><img src="/themes/farmie/img/core-img/logo2.png" alt=""></a>
            ...
            <div class="footer-widget mb-80">
              ...
              <div class="single-recent-blog d-flex align-items-center">
                <div class="post-thumbnail">
                  <img src="/themes/farmie/img/bg-img/4.jpg" alt="">
                </div>
                <div class="post-content">
              ...
              <div class="single-recent-blog d-flex align-items-center">
                <div class="post-thumbnail">
                  <img src="/themes/farmie/img/bg-img/5.jpg" alt="">
                </div>
                <div class="post-content">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
  ...
  <!-- jquery 2.2.4  -->
  <script src="/themes/farmie/js/jquery.min.js"></script>
  <!-- Popper js -->
  <script src="/themes/farmie/js/popper.min.js"></script>
  <!-- Bootstrap js -->
  <script src="/themes/farmie/js/bootstrap.min.js"></script>
  <!-- Owl Carousel js -->
  <script src="/themes/farmie/js/owl.carousel.min.js"></script>
  <!-- Classynav -->
  <script src="/themes/farmie/js/classynav.js"></script>
  <!-- Wow js -->
  <script src="/themes/farmie/js/wow.min.js"></script>
  <!-- Sticky js -->
  <script src="/themes/farmie/js/jquery.sticky.js"></script>
  <!-- Magnific Popup js -->
  <script src="/themes/farmie/js/jquery.magnific-popup.min.js"></script>
  <!-- Scrollup js -->
  <script src="/themes/farmie/js/jquery.scrollup.min.js"></script>
  <!-- Jarallax js -->
  <script src="/themes/farmie/js/jarallax.min.js"></script>
  <!-- Jarallax Video js -->
  <script src="/themes/farmie/js/jarallax-video.min.js"></script>
  <!-- Active js -->
  <script src="/themes/farmie/js/active.js"></script>
</body>
